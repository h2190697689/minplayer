...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    /*代理*/
    before(app) {
       app.get('/getHomeList',function (req,res) {
         var url = 'https://c.y.qq.com/musichall/fcgi-bin/fcg_yqqhomepagerecommend.fcg' // 原api
         axios.get(url, {
           headers: {
       ...
       app.get('/getHomeDetail',function (req,res) {
       ...
       app.get('/getTopMusic',function (req,res) {
           var url = 'https://c.y.qq.com/v8/fcg-bin/fcg_v8_toplist_cp.fcg' // 原api
           axios.get(url, {
             headers: {
               referer: 'https://c.y.qq.com/',
       ...
       app.get('/getPlayDetail',function (req,res) {
       ...
       app.get('/getAlbumDetail',function (req,res) {
           var url = 'https://c.y.qq.com/v8/fcg-bin/fcg_v8_album_info_cp.fcg' // 原api
           axios.get(url, {
             headers: {
               referer: 'https://c.y.qq.com/',
               host: 'c.y.qq.com'
       ...
       app.get('/getHotKey',function (req,res) {
           var url = 'https://c.y.qq.com/splcloud/fcgi-bin/gethotkey.fcg' // 原api
           axios.get(url, {
             headers: {
               referer: 'https://y.qq.com/',
               host: 'u.y.qq.com'
    ...
    disableHostCheck: true  //内网穿透时自己加的
  },
  plugins: [
